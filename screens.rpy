...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("Начать"):
                text_color "#ffffffc2"         # Неактивный
                text_selected_color "#B0E0E6"        # Наведение курсора
                text_hover_color "#ff0000"     # Если эта кнопка активна (но редко используется для 'Начать')
                action Start()
...
## https://www.renpy.org/doc/html/screen_special.html#main-menu
    ...
    # --- ДОБАВЬТЕ ЭТОТ БЛОК КОДА ПЕРЕД screen main_menu: ---

# Переменная для хранения координат мыши.
# Мы будем обновлять эти координаты в цикле (on_idle).
